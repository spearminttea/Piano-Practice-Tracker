...
class MetronomeViewModel: ObservableObject {
    ...
    @Published var beatsPerMinute: Int {
        didSet {
            ...
            UserDefaults.standard.setValue(beatsPerMinute, forKey: MetronomeDefaults.beatsPerMinute)
    ...
    @Published var beatsPerMeasure: Int {
        didSet {
            ...
            UserDefaults.standard.setValue(beatsPerMeasure, forKey: MetronomeDefaults.beatsPerMeasure)
        }
    }
    ...
    @Published var accentFirstBeatEnabled: Bool {
        didSet {
            UserDefaults.standard.setValue(accentFirstBeatEnabled, forKey: MetronomeDefaults.accentFirstBeatEnabled)
        }
    }
    ...
    @Published var beatsPlayed: BeatsPlayed {
        didSet {
            UserDefaults.standard.setValue(beatsPlayed.rawValue, forKey: MetronomeDefaults.beatsPlayed)
        }
    }
    ...
    @Published var soundEnabled: Bool {
        didSet {
            UserDefaults.standard.setValue(soundEnabled, forKey: MetronomeDefaults.soundEnabled)
        }
    }
    
    private let metronomeDispatchQueue = DispatchQueue(label: "net.sanjanaarunkumariyer.Pianify.metronome", qos: .userInteractive, attributes: .concurrent)
    ...
    init() {
        ...
        beatsPerMinute = max(
            min(
                userDefaults.integer(forKey: MetronomeDefaults.beatsPerMinute),
                maxBeatsPerMinute
            ),
            minBeatsPerMinute)
        
        beatsPerMeasure = userDefaults.integer(forKey: MetronomeDefaults.beatsPerMeasure)
        accentFirstBeatEnabled = userDefaults.bool(forKey: MetronomeDefaults.accentFirstBeatEnabled)
        beatsPlayed = BeatsPlayed(rawValue: userDefaults.string(forKey: MetronomeDefaults.beatsPlayed) ?? BeatsPlayed.all.rawValue) ?? .all
        soundEnabled = userDefaults.bool(forKey: MetronomeDefaults.soundEnabled)
